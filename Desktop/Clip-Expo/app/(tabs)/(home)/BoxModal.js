...
import userItems from "../../../mocks/userItems";
    ...
    >
      <TouchableOpacity
        style={[
          ...
          selectedItem && selectedItem.itemCategorySeq === item.itemCategorySeq
            ? styles.selectedItem
            : null,
        ]}
        ...
        activeOpacity={0.7}
      >
        <Image source={item.itemPictures[0]} style={styles.itemImage} />
      ...
      <GestureHandlerRootView style={styles.container}>
        <SafeAreaView>
          <FlatList
            ...
            keyExtractor={(item) => item.itemCategorySeq.toString()}
          />
        </SafeAreaView>
      </GestureHandlerRootView>
    </>
